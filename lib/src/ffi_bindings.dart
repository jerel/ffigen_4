...
class NativeLibrary {
  ...
  late final _examplePtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Int32)>>('example');
  late final _example = _examplePtr.asFunction<int Function(int)>();
}
...
const int __WATCHOS_6_0_1 = 60001;
